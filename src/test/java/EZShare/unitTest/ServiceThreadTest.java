    ...
    class DummyServer {
        ...
        void dummyServerAccept() {
            ...
            try {
                ...
                ServiceThread serviceThread = new ServiceThread(lastConnectionTime, clientSocket, secret,
                        resourceStorage, serverList, self, true, new SubscriptionManager());
...
//                "'ezserver': null}}");
        ...
        commandFail.add("{'command': 'SHARE', " +
                ...
                "'tags': [], " +
                "'description': '', " +
                "'uri': 'file:\\/\\/\\/~/Desktop/testAndStopServer.png', " +
                "'channel': 'Personal', " +
                "'owner': 'Leo', " +
                "'ezserver': null}}");
...
//                "'tags': [], " +
//                "'description': '', " +
//                "'uri': 'file:\\/\\/home/Desktop/testAndStopServer.png', " +
//                "'channel': 'Personal', " +
//                "'owner': 'Leo', " +
//                "'ezserver': null}}");
